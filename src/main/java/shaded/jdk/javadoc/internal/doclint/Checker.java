...
import shaded.javax.lang.model.element.RecordComponentElement;
import shaded.javax.lang.model.element.TypeElement;
import shaded.javax.lang.model.element.VariableElement;
...
import shaded.javax.tools.Diagnostic.Kind;
import shaded.javax.tools.JavaFileObject;

import shaded.com.sun.source.doctree.AttributeTree;
import shaded.com.sun.source.doctree.AuthorTree;
import shaded.com.sun.source.doctree.DocCommentTree;
import shaded.com.sun.source.doctree.DocRootTree;
import shaded.com.sun.source.doctree.DocTree;
import shaded.com.sun.source.doctree.EndElementTree;
import shaded.com.sun.source.doctree.EntityTree;
import shaded.com.sun.source.doctree.ErroneousTree;
import shaded.com.sun.source.doctree.EscapeTree;
import shaded.com.sun.source.doctree.IdentifierTree;
import shaded.com.sun.source.doctree.IndexTree;
import shaded.com.sun.source.doctree.InheritDocTree;
import shaded.com.sun.source.doctree.LinkTree;
import shaded.com.sun.source.doctree.LiteralTree;
import shaded.com.sun.source.doctree.ParamTree;
import shaded.com.sun.source.doctree.ProvidesTree;
import shaded.com.sun.source.doctree.ReferenceTree;
import shaded.com.sun.source.doctree.RawTextTree;
import shaded.com.sun.source.doctree.ReturnTree;
import shaded.com.sun.source.doctree.SeeTree;
import shaded.com.sun.source.doctree.SerialDataTree;
import shaded.com.sun.source.doctree.SerialFieldTree;
import shaded.com.sun.source.doctree.SinceTree;
import shaded.com.sun.source.doctree.StartElementTree;
import shaded.com.sun.source.doctree.SummaryTree;
import shaded.com.sun.source.doctree.SystemPropertyTree;
import shaded.com.sun.source.doctree.TextTree;
import shaded.com.sun.source.doctree.ThrowsTree;
import shaded.com.sun.source.doctree.UnknownBlockTagTree;
import shaded.com.sun.source.doctree.UnknownInlineTagTree;
import shaded.com.sun.source.doctree.UsesTree;
import shaded.com.sun.source.doctree.ValueTree;
import shaded.com.sun.source.doctree.VersionTree;
import shaded.com.sun.source.tree.Tree;
import shaded.com.sun.source.util.DocTreePath;
import shaded.com.sun.source.util.DocTreePathScanner;
import shaded.com.sun.source.util.TreePath;
import shaded.com.sun.tools.javac.tree.DocPretty;
import shaded.com.sun.tools.javac.util.Assert;
...
public class Checker extends DocTreePathScanner<Void, Void> {
    ...
    private boolean isImplicitlyDeclaredClass(Tree t) {
        if (t.getKind() == Tree.Kind.CLASS && t instanceof shaded.com.sun.tools.javac.tree.JCTree.JCClassDecl) {
            shaded.com.sun.tools.javac.tree.JCTree.JCClassDecl classDecl = (shaded.com.sun.tools.javac.tree.JCTree.JCClassDecl) t;
            return (classDecl.mods.flags & shaded.com.sun.tools.javac.code.Flags.IMPLICIT_CLASS) != 0;
        }
        return false;
    }
